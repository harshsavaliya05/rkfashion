  ...
  private defaultBlogs = [
    {
      ...
      category: 'Fashion',
      content: 'Curling irons have come a long way over the years, and finding the perfect one can make all the difference for your style. Whether you are looking for loose waves, tight curls, or something in between, the right tool is essential.\n\nWhen choosing a curling iron, you need to consider the barrel size, material (like ceramic, tourmaline, or titanium), and temperature settings. A ceramic barrel is perfect for thin or normal hair as it distributes heat evenly, while titanium is ideal for coarse or thick hair.',
      quote: 'Invest in your hair, it is the crown you never take off.',
      quoteAuthor: 'John Smith',
      tags: ['Fashion', 'Trending', '2026']
    },
    {
